...
/*************** PRODUCT LISTS FILTERS - begin ***************/
	...
	add_action( 'woocommerce_before_shop_loop', 'biagiotti_mikado_pl_child_controls_before', 19 );
	add_action( 'woocommerce_before_shop_loop', 'biagiotti_mikado_pl_child_controls_after', 31 );

	//Add additional html tags around product lists
	add_action( 'woocommerce_before_shop_loop', 'biagiotti_mikado_pl_child_holder_additional_tag_before', 35 );
	add_action( 'woocommerce_after_shop_loop', 'biagiotti_mikado_pl_child_holder_additional_tag_after', 5 );
	
	//Add additional html tag around product elements
	add_action( 'woocommerce_before_shop_loop_item', 'biagiotti_mikado_pl_child_inner_additional_tag_before', 5 );
	...
	add_action( 'woocommerce_before_shop_loop_item_title', 'biagiotti_mikado_pl_child_image_additional_tag_before', 5 );
	add_action( 'biagiotti_mikado_action_woo_pl_info_below_image', 'biagiotti_mikado_pl_child_image_additional_tag_after', 6 );
	add_action( 'biagiotti_mikado_action_woo_pl_info_on_image_hover', 'biagiotti_mikado_pl_child_image_additional_tag_after', 1 );
	...
	/*************** Product Info Position Is On Image Hover ***************/
		...
		add_action( 'biagiotti_mikado_action_woo_pl_info_on_image_hover', 'biagiotti_mikado_pl_child_inner_additional_tag_after', 22 );
		
		//Add additional html around product info elements
		add_action( 'biagiotti_mikado_action_woo_pl_info_on_image_hover', 'biagiotti_mikado_pl_child_inner_text_additional_tag_before', 5 );
		add_action( 'biagiotti_mikado_action_woo_pl_info_on_image_hover', 'biagiotti_mikado_pl_child_inner_text_additional_tag_after', 17 );
		...
		add_action( 'biagiotti_mikado_action_woo_pl_info_on_image_hover', 'biagiotti_mikado_pl_child_rating_additional_tag_before', 9 );
		add_action( 'biagiotti_mikado_action_woo_pl_info_on_image_hover', 'woocommerce_template_loop_rating', 10 );
		add_action( 'biagiotti_mikado_action_woo_pl_info_on_image_hover', 'biagiotti_mikado_pl_child_rating_additional_tag_after', 11 );

		// Add To Cart
		remove_action( 'woocommerce_after_shop_loop_item', 'woocommerce_template_loop_add_to_cart', 10 );
		add_action( 'biagiotti_mikado_action_woo_pl_info_on_image_hover', 'biagiotti_mikado_pl_child_action_buttons_tag_before', 12 );
		add_action( 'biagiotti_mikado_action_woo_pl_info_on_image_hover', 'woocommerce_template_loop_add_to_cart', 13 );
		add_action( 'biagiotti_mikado_action_woo_pl_info_on_image_hover', 'biagiotti_mikado_pl_child_action_buttons_tag_after', 16 );

/*************** Product Info Position Is Below Image ***************/

		// Add To Cart
		remove_action( 'woocommerce_after_shop_loop_item', 'woocommerce_template_loop_add_to_cart', 10 );
		add_action( 'biagiotti_mikado_action_woo_pl_info_below_image', 'biagiotti_mikado_pl_child_inner_text_additional_tag_before', 1 );
		add_action( 'biagiotti_mikado_action_woo_pl_info_below_image', 'woocommerce_template_loop_add_to_cart', 2 );
		add_action( 'biagiotti_mikado_action_woo_pl_info_below_image', 'biagiotti_mikado_pl_child_inner_text_additional_tag_after', 5 );
		...
		add_action( 'biagiotti_mikado_action_woo_pl_info_below_image', 'biagiotti_mikado_pl_child_inner_additional_tag_after', 21 );
		
		// Add additional html at the end of product info elements
		add_action( 'biagiotti_mikado_action_woo_pl_info_below_image', 'biagiotti_mikado_pl_child_text_wrapper_additional_tag_before', 22 );
		add_action( 'biagiotti_mikado_action_woo_pl_info_below_image', 'biagiotti_mikado_pl_child_text_wrapper_additional_tag_after', 30 );
		...
		// Star Rating
		remove_action( 'woocommerce_after_shop_loop_item_title', 'woocommerce_template_loop_rating', 5 );
		add_action( 'biagiotti_mikado_action_woo_pl_info_below_image', 'biagiotti_mikado_pl_child_rating_additional_tag_before', 26 );
		add_action( 'biagiotti_mikado_action_woo_pl_info_below_image', 'woocommerce_template_loop_rating', 27 );
		add_action( 'biagiotti_mikado_action_woo_pl_info_below_image', 'biagiotti_mikado_pl_child_rating_additional_tag_after', 28 );
