...
if ( ! function_exists( 'biagiotti_mikado_include_woocommerce_shortcodes' ) ) {
	function biagiotti_mikado_include_woocommerce_shortcodes() {
		if( biagiotti_mikado_is_theme_registered() ) {
			foreach ( glob( CHILD_BIAGIOTTI_MIKADO_FRAMEWORK_MODULES_ROOT_DIR . '/woocommerce/shortcodes/*/load.php' ) as $shortcode_load ) {
				include_once $shortcode_load;
			}
		}
	}
	
	if ( biagiotti_mikado_child_is_plugin_installed( 'core' ) ) {
