            ...
            var mkdfAnimateBiagiottiSpinner = function () {
              textArray.forEach(function (item, index) {
                preloaderText
                  .find("span")
                  .eq(index)
                  .css({ opacity: "1", transition: "1.5s " + 0.1 * index + "s" });
              });
...
(function ($) {
  ...
  if (typeof mkdfInitSelect2 == "function") {
    window.mkdfInitSelect2 = function () {
      mkdfInitSelect2();
    };
  }
    ...
    function productExhibitionHolderItemsAppear() {
      if (productExhibitionHolder.length) {
        productExhibitionHolder.each(function () {
          $(this)
            .find(".mkdf-pli, .mkdf-pe-background")
            .each(function () {
        ...
        elementsHolderItem.each(function () {
          ...
          if (largeLaptop.length || smallLaptop.length || ipadLandscape.length || ipadPortrait.length || mobileLandscape.length || mobilePortrait.length) {
            if (largeLaptop.length) {
              responsiveStyle +=
                "@media only screen and (min-width: 1400px) and (max-width: 1600px) {.mkdf-eh-item-content." + itemClass + " { padding: " + largeLaptop + " !important; } }";
            }
            if (smallLaptop.length) {
              responsiveStyle +=
                "@media only screen and (min-width: 1025px) and (max-width: 1399px) {.mkdf-eh-item-content." + itemClass + " { padding: " + smallLaptop + " !important; } }";
            }
            if (ipadLandscape.length) {
              responsiveStyle +=
                "@media only screen and (min-width: 769px) and (max-width: 1024px) {.mkdf-eh-item-content." + itemClass + " { padding: " + ipadLandscape + " !important; } }";
            }
            if (ipadPortrait.length) {
              responsiveStyle +=
                "@media only screen and (min-width: 681px) and (max-width: 768px) {.mkdf-eh-item-content." + itemClass + " { padding: " + ipadPortrait + " !important; } }";
            }
          ...
          if (typeof mkdf.modules.common.mkdfOwlSlider === "function") {
            // if owl function exist
            var owl = thisItem.find(".mkdf-owl-slider");
            if (owl.length) {
              // if owl is in elements holder
              setTimeout(function () {
  ...
  function mkdfInitFullScreenSections() {
    ...
    if (fullScreenSections.length) {
      fullScreenSections.each(function () {
        ...
        if (
          typeof thisFullScreenSections.data("enable-continuous-vertical") !== "undefined" &&
          thisFullScreenSections.data("enable-continuous-vertical") !== false &&
          thisFullScreenSections.data("enable-continuous-vertical") === "yes"
        ) {
