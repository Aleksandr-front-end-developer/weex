...
if ( ! function_exists( 'biagiotti_mikado_add_simple_line_icon_pack' ) ) {
	function biagiotti_mikado_add_simple_line_icon_pack( $iconCollections ) {
		$iconCollections['simple_line_icons'] = new BiagiottiMikadoClassSimpleLineIcons( 'Simple Line Icons', 'simple_line_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'biagiotti_mikado_filter_add_icon_pack_into_collection', 'biagiotti_mikado_add_simple_line_icon_pack' );
}

if ( ! function_exists( 'biagiotti_mikado_add_simple_line_icon_pack_option' ) ) {
	function biagiotti_mikado_add_simple_line_icon_pack_option( $options ) {
		$options['simple_line_icons'] = esc_html__( 'Simple Line Icons', 'biagiotti' );
		
		return $options;
	}
	
	add_filter( 'biagiotti_mikado_filter_add_icon_pack_into_options', 'biagiotti_mikado_add_simple_line_icon_pack_option' );
	add_filter( 'biagiotti_mikado_filter_add_icon_pack_into_social_options', 'biagiotti_mikado_add_simple_line_icon_pack_option' );
}

class BiagiottiMikadoClassSimpleLineIcons implements iBiagiottiMikadoInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
    ...
    public function __construct($title = "", $param = "") {
        ...
        $this->styleUrl = BIAGIOTTI_MIKADO_FRAMEWORK_ICONS_ROOT . '/simple-line-icons/simple-line-icons.css';
    }
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'biagiotti'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'biagiotti'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'biagiotti'),
            'icon-social-facebook'    => esc_html__('Facebook', 'biagiotti'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'biagiotti'),
            'icon-social-github'      => esc_html__('Github', 'biagiotti'),
            'icon-social-instagram'   => esc_html__('Instagram', 'biagiotti'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'biagiotti'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'biagiotti'),
            'icon-social-reddit'      => esc_html__('Reddit', 'biagiotti'),
            'icon-social-skype'       => esc_html__('Skype', 'biagiotti'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'biagiotti'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'biagiotti'),
            'icon-social-spotify'     => esc_html__('Spotify', 'biagiotti'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'biagiotti'),
            'icon-social-twitter'     => esc_html__('Twitter', 'biagiotti'),
            'icon-social-youtube'     => esc_html__('Youtube', 'biagiotti')
        );
    }
