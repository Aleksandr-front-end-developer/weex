...
if ( ! function_exists( 'biagiotti_mikado_add_font_awesome_icon_pack' ) ) {
	function biagiotti_mikado_add_font_awesome_icon_pack( $iconCollections ) {
		$iconCollections['font_awesome'] = new BiagiottiMikadoClassIconsFontAwesome( 'Font Awesome', 'fa_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'biagiotti_mikado_filter_add_icon_pack_into_collection', 'biagiotti_mikado_add_font_awesome_icon_pack' );
}

if ( ! function_exists( 'biagiotti_mikado_add_font_awesome_icon_pack_option' ) ) {
	function biagiotti_mikado_add_font_awesome_icon_pack_option( $options ) {
		$options['font_awesome'] = esc_html__( 'Font Awesome', 'biagiotti' );
		
		return $options;
	}
	
	add_filter( 'biagiotti_mikado_filter_add_icon_pack_into_options', 'biagiotti_mikado_add_font_awesome_icon_pack_option' );
	add_filter( 'biagiotti_mikado_filter_add_icon_pack_into_social_options', 'biagiotti_mikado_add_font_awesome_icon_pack_option' );
}

class BiagiottiMikadoClassIconsFontAwesome implements iBiagiottiMikadoInterfaceIconCollection {
	public $icons;
	public $socialIcons;
	public $title;
	public $param;
	...
	function __construct($title = "", $param = "") {
		...
		$this->styleUrl = BIAGIOTTI_MIKADO_FRAMEWORK_ICONS_ROOT . '/font-awesome/css/fontawesome-all.min.css';
	}
	...
	private function getNewIconsArray( $brandsIcons = false ) {
		...
		$iconsArray = array();
		$icons      = json_decode( $wp_filesystem->get_contents( BIAGIOTTI_MIKADO_FRAMEWORK_ICONS_ROOT_DIR . '/font-awesome/icons.json' ) );
