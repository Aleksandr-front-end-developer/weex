...
if ( ! function_exists( 'biagiotti_mikado_add_font_elegant_icon_pack' ) ) {
	function biagiotti_mikado_add_font_elegant_icon_pack( $iconCollections ) {
		$iconCollections['font_elegant'] = new BiagiottiMikadoClassIconsFontElegant( 'Font Elegant', 'fe_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'biagiotti_mikado_filter_add_icon_pack_into_collection', 'biagiotti_mikado_add_font_elegant_icon_pack' );
}

if ( ! function_exists( 'biagiotti_mikado_add_font_elegant_icon_pack_option' ) ) {
	function biagiotti_mikado_add_font_elegant_icon_pack_option( $options ) {
		$options['font_elegant'] = esc_html__( 'Font Elegant', 'biagiotti' );
		
		return $options;
	}
	
	add_filter( 'biagiotti_mikado_filter_add_icon_pack_into_options', 'biagiotti_mikado_add_font_elegant_icon_pack_option' );
	add_filter( 'biagiotti_mikado_filter_add_icon_pack_into_social_options', 'biagiotti_mikado_add_font_elegant_icon_pack_option' );
}

class BiagiottiMikadoClassIconsFontElegant implements iBiagiottiMikadoInterfaceIconCollection {
	public $icons;
	public $socialIcons;
	public $title;
	public $param;
	...
	function __construct($title = "", $param = "") {
		...
		$this->styleUrl = BIAGIOTTI_MIKADO_FRAMEWORK_ICONS_ROOT . '/elegant-icons/style.min.css';
	}
