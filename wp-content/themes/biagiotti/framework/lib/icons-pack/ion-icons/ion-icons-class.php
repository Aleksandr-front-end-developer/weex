...
if ( ! function_exists( 'biagiotti_mikado_add_ion_icon_pack' ) ) {
	function biagiotti_mikado_add_ion_icon_pack( $iconCollections ) {
		$iconCollections['ion_icons'] = new BiagiottiMikadoClassIonIcons( 'Ion Icons', 'ion_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'biagiotti_mikado_filter_add_icon_pack_into_collection', 'biagiotti_mikado_add_ion_icon_pack' );
}

if ( ! function_exists( 'biagiotti_mikado_add_ion_icon_pack_option' ) ) {
	function biagiotti_mikado_add_ion_icon_pack_option( $options ) {
		$options['ion_icons'] = esc_html__( 'Ion Icons', 'biagiotti' );
		
		return $options;
	}
	
	add_filter( 'biagiotti_mikado_filter_add_icon_pack_into_options', 'biagiotti_mikado_add_ion_icon_pack_option' );
	add_filter( 'biagiotti_mikado_filter_add_icon_pack_into_social_options', 'biagiotti_mikado_add_ion_icon_pack_option' );
}

class BiagiottiMikadoClassIonIcons implements iBiagiottiMikadoInterfaceIconCollection {
	public $icons;
	public $socialIcons;
    public $title;
	public $param;
	...
	function __construct($title = "", $param = "") {
		...
		$this->styleUrl = BIAGIOTTI_MIKADO_FRAMEWORK_ICONS_ROOT . '/ion-icons/css/ionicons.min.css';
	}
	...
	public function getSearchIcon() {
		...
		return $this->render('ion-android-search');
	}
