<?php
namespace BiagiottiCore\CPT\Shortcodes\ProductInfo;
...
class ProductInfo implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if(function_exists('vc_map')) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Product Info', 'biagiotti' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						array(
							...
							'heading'     => esc_html__( 'Selected Product', 'biagiotti' ),
							'settings'    => array(
								'sortable'      => true,
								'unique_values' => true
							),
						...
						array(
							...
							'heading'     => esc_html__( 'Product Info Type', 'biagiotti' ),
							'value'       => array(
								esc_html__( 'Title', 'biagiotti' )          => 'title',
								esc_html__( 'Featured Image', 'biagiotti' ) => 'featured_image',
								esc_html__( 'Category', 'biagiotti' )       => 'category',
								esc_html__( 'Excerpt', 'biagiotti' )        => 'excerpt',
								esc_html__( 'Price', 'biagiotti' )          => 'price',
								esc_html__( 'Rating', 'biagiotti' )         => 'rating',
								esc_html__( 'Add To Cart', 'biagiotti' )    => 'add_to_cart',
								esc_html__( 'Tag', 'biagiotti' )            => 'tag',
								esc_html__( 'Author', 'biagiotti' )         => 'author',
								esc_html__( 'Date', 'biagiotti' )           => 'date',
							),
							'admin_label' => true
						),
						array(
							...
							'heading'    => esc_html__( 'Product Info Color', 'biagiotti' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Featured Image Proportions', 'biagiotti' ),
							'value'      => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Category Tag', 'biagiotti' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Add To Cart Skin', 'biagiotti' ),
							'value'      => array(
								esc_html__( 'Default', 'biagiotti' ) => '',
