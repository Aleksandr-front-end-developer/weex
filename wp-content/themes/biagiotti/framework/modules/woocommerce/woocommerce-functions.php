...
if ( ! function_exists( 'biagiotti_mikado_get_woocommerce_sale' ) ) {
	function biagiotti_mikado_get_woocommerce_sale( $product ) {
		...
		if ( $price > 0 && $enable_percent_mark === 'yes' ) {
			return '-' . ( 100 - round( ( ( $sale_price * 100 ) / $price ), 2 ) ) . '%';
		} else {
...
if ( ! function_exists( 'biagiotti_mikado_is_qode_quick_view_for_woocommerce_installed' ) ) {
    function biagiotti_mikado_is_qode_quick_view_for_woocommerce_installed() {
...
if ( ! function_exists( 'biagiotti_mikado_is_qode_wishlist_for_woocommerce_installed' ) ) {
	function biagiotti_mikado_is_qode_wishlist_for_woocommerce_installed() {
