...
$i++;
$cfg['Servers'][$i]['host'] 			= 'weex2.mysql.tools';
$cfg['Servers'][$i]['port'] 			= '';
$cfg['Servers'][$i]['connect_type'] 	= 'tcp';
$cfg['Servers'][$i]['socket'] 			= '';
$cfg['Servers'][$i]['AllowNoPassword']	= false;   // true/false
$cfg['blowfish_secret']					= 'Z~2MXN;!2=M.9y_ba\"*U6\"J!R9zQzny\\' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_ZCG3daJ8fnlLk7VioDuPEzQ/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
...
$cfg['Servers'][$i]['SignonURL']    = 'https://weexnail.com/wp-admin/?rand=81227558&goto_wp_phpmyadmin=1';
$cfg['Servers'][$i]['LogoutURL']    = 'https://weexnail.com/wp-admin/?rand=27182603&pma_logout=1';
