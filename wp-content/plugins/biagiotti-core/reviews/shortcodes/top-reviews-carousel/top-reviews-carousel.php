...
namespace BiagiottiCore\CPT\Shortcodes\TopReviewsCarousel;

use BiagiottiCore\Lib\ShortcodeInterface;

class TopReviewsCarousel implements ShortcodeInterface {
	private $base;
	
	public function __construct() {
		$this->base = 'biagiotti_core_top_reviews_carousel';
	...
	public function vcMap() {
		$criteria_ratings = biagiotti_core_rating_criteria_for_vc();
		
		vc_map(
			array(
				'name'                      => esc_html__( 'Top Reviews Carousel', 'biagiotti-core' ),
				'base'                      => $this->base,
				...
				'params'                    => array(
					...
					array(
						...
						'heading'     => esc_html__( 'Number of Reviews', 'biagiotti-core' ),
						'description' => esc_html__( 'Leave empty for all', 'biagiotti-core' )
					),
					array(
						'type'        => 'dropdown',
						'param_name'  => 'review_criteria',
						'heading'     => esc_html__( 'Order by Review Criteria', 'biagiotti-core' ),
	...
	public function render( $atts, $content = null ) {
		...
		return biagiotti_core_get_module_shortcode_template_part( 'reviews', 'top-reviews-carousel', 'top-reviews-carousel', '', $params );
	}
