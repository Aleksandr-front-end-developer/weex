<div class="mkdf-core-dashboard wrap about-wrap">
	<h1 class="mkdf-cd-title"><?php esc_html_e('System Status', 'biagiotti-core'); ?></h1>
	<h4 class="mkdf-cd-subtitle"><?php esc_html_e('Here is a general overview of your system status', 'biagiotti-core'); ?></h4>
	<div class="mkdf-core-dashboard-inner">
		<div class="mkdf-core-dashboard-column">
			<div class="mkdf-core-dashboard-box">
				<div class="mkdf-cd-box-title-holder">
					<h2><?php esc_html_e('WordPress Environment', 'biagiotti-core'); ?></h2>
				</div>
		...
		<div class="mkdf-core-dashboard-column">
			<div class="mkdf-core-dashboard-box">
				<div class="mkdf-cd-box-title-holder">
					<h2><?php esc_html_e('Theme Information', 'biagiotti-core'); ?></h2>
				</div>
				<div class="mkdf-cd-box-inner">
			...
			<div class="mkdf-core-dashboard-box">
				<div class="mkdf-cd-box-title-holder">
					<h2><?php esc_html_e('Active Plugins', 'biagiotti-core'); ?><sup>(<?php echo count($plugins); ?>)</sup></h2>
				</div>
				<div class="mkdf-cd-box-inner">
					<?php foreach ($plugins as $plugin_key => $plugin_value): ?>
						<div class="mkdf-cd-box-row">
							...
							<div class="mkdf-cdb-value"><?php esc_html_e('by', 'biagiotti-core'); ?> <a href="<?php echo esc_url($plugin_value['author_url']); ?>"><?php echo wp_kses_post($plugin_value['author']); ?></a> - <?php echo wp_kses_post($plugin_value['version']); ?></div>
						</div>
					<?php endforeach; ?>
				</div>
			</div>
