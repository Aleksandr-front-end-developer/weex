...
if ( ! class_exists( 'BiagiottiCoreDashboardRestAPI' ) ) {
	 ...
	 */
	class BiagiottiCoreDashboardRestAPI {
		...
		public function __construct() {
			...
			add_filter( 'biagiotti_core_dashboard_filter_js_global_variables', array( $this, 'localize_script' ) );
	...
	BiagiottiCoreDashboardRestAPI::get_instance();
}
