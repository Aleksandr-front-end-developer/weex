<?php
if ( ! function_exists( 'biagiotti_mikado_init_google_fonts_array' ) ) {
    function biagiotti_mikado_init_google_fonts_array() {
...
';
        ...
        $biagiotti_mikado_global_fonts_array = $google_fonts_decoded['items'];
    }
    add_action('after_setup_theme', 'biagiotti_mikado_init_google_fonts_array');
}