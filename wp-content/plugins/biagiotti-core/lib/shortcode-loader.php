...
namespace BiagiottiCore\Lib;

/**
 * Class ShortcodeLoader
 * @package BiagiottiCore\Lib
 */
class ShortcodeLoader {
	/**
	...
	private function addShortcodes() {
		$shortcodes_class_name = apply_filters( 'biagiotti_core_filter_add_vc_shortcode', $shortcodes_class_name = array() );
