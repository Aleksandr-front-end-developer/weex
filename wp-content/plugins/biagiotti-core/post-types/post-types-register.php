...
namespace BiagiottiCore\CPT;

use BiagiottiCore\Lib;

/**
 * Class PostTypesLoader
 * @package BiagiottiCore\CPT
 */
class PostTypesRegister {
	...
	private function addPostTypes() {
		$cpt_class_name = apply_filters( 'biagiotti_core_filter_register_custom_post_types', $cpt_class_name = array() );
