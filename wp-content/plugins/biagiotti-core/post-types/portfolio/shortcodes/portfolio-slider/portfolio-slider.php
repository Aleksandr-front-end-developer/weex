...
class PortfolioSlider implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'     => esc_html__( 'Portfolio Slider', 'biagiotti-core' ),
					'base'     => $this->base,
					...
					'params'   => array(
						array(
							...
							'heading'     => esc_html__( 'Number of Portfolios Items', 'biagiotti-core' ),
							'admin_label' => true,
							'description' => esc_html__( 'Set number of items for your portfolio slider. Enter -1 to show all', 'biagiotti-core' )
						),
						array(
							'type'       => 'dropdown',
						...
						array(
							...
							'description' => esc_html__( 'Number of portfolios that are showing at the same time in slider (on smaller screens is responsive so there will be less items shown). Default value is Four', 'biagiotti-core' ),
							'save_always' => true
						),
						array(
							'type'        => 'dropdown',
						...
						array(
							...
							'description' => esc_html__( 'Set image proportions for your portfolio slider.', 'biagiotti-core' ),
							'save_always' => true
						),
						array(
							'type'        => 'textfield',
						...
						array(
							...
							'heading'    => esc_html__( 'Navigation Skin', 'biagiotti-core' ),
							'value'      => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Navigation Position', 'biagiotti-core' ),
							'value'      => array(
								esc_html__( 'Inside Carousel', 'biagiotti-core' )  => '',
								esc_html__( 'Outside Carousel', 'biagiotti-core' ) => 'outside-slider'
							),
							'dependency' => array( 'element' => 'enable_navigation', 'value' => array( 'yes' ) ),
							'group'      => esc_html__( 'Slider Settings', 'biagiotti-core' )
						),
						...
						array(
							...
							'heading'    => esc_html__( 'Pagination Skin', 'biagiotti-core' ),
							'value'      => array(
								esc_html__( 'Default', 'biagiotti-core' ) => '',
								esc_html__( 'Light', 'biagiotti-core' )   => 'light'
							),
						...
						array(
							...
							'heading'     => esc_html__( 'Pagination Position', 'biagiotti-core' ),
							'value'       => array(
								esc_html__( 'Below Slider', 'biagiotti-core' )  => 'below-slider',
								esc_html__( 'Inside Slider', 'biagiotti-core' ) => 'inside-slider'
							),
							'save_always' => true,
							'dependency'  => array( 'element' => 'enable_pagination', 'value' => array( 'yes' ) ),
							'group'       => esc_html__( 'Slider Settings', 'biagiotti-core' )
