...
class PortfolioList implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map( array(
					'name'     => esc_html__( 'Portfolio List', 'biagiotti-core' ),
					'base'     => $this->getBase(),
					...
					'params'   => array(
						array(
							'type'        => 'dropdown',
							'param_name'  => 'type',
							'heading'     => esc_html__( 'Portfolio List Template', 'biagiotti-core' ),
							'value'       => array(
								esc_html__( 'Gallery', 'biagiotti-core' ) => 'gallery',
								esc_html__( 'Masonry', 'biagiotti-core' ) => 'masonry'
							),
							'save_always' => true,
							'admin_label' => true
						),
						array(
							...
							'heading'    => esc_html__( 'Click Behavior', 'biagiotti-core' ),
							'value'      => array(
								esc_html__( 'Open portfolio single page on click', 'biagiotti-core' )   => '',
								esc_html__( 'Open gallery in Pretty Photo on click', 'biagiotti-core' ) => 'gallery'
							)
						),
						array(
							'type'        => 'dropdown',
						...
						array(
							...
							'heading'     => esc_html__( 'Number of Portfolios Per Page', 'biagiotti-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Fixed Image Proportions', 'biagiotti-core' ),
							'value'       => array_flip( biagiotti_mikado_get_yes_no_select_array( false ) ),
							'description' => esc_html__( 'Set predefined image proportions for your masonry portfolio list. This option will apply image proportions you set in Portfolio Single page - dimensions for masonry option.', 'biagiotti-core' ),
						...
						array(
							'type'        => 'autocomplete',
							'param_name'  => 'category',
							'heading'     => esc_html__( 'One-Category Portfolio List', 'biagiotti-core' ),
							'description' => esc_html__( 'Enter one category slug (leave empty for showing all categories)', 'biagiotti-core' )
						),
						array(
							'type'        => 'autocomplete',
							'param_name'  => 'selected_projects',
							'heading'     => esc_html__( 'Show Only Projects with Listed IDs', 'biagiotti-core' ),
							'settings'    => array(
								'multiple'      => true,
								'sortable'      => true,
								'unique_values' => true
						...
						array(
							'type'        => 'autocomplete',
							'param_name'  => 'tag',
							'heading'     => esc_html__( 'One-Tag Portfolio List', 'biagiotti-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Item Style', 'biagiotti-core' ),
							'value'      => array(
								esc_html__( 'Standard - Shader', 'biagiotti-core' )                 => 'standard-shader',
								esc_html__( 'Standard - Switch Featured Images', 'biagiotti-core' ) => 'standard-switch-images',
								esc_html__( 'Gallery - Overlay', 'biagiotti-core' )                 => 'gallery-overlay'
							),
							'group'      => esc_html__( 'Content Layout', 'biagiotti-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'content_top_margin',
							'heading'    => esc_html__( 'Content Top Margin (px or %)', 'biagiotti-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Content Bottom Margin (px or %)', 'biagiotti-core' ),
							'dependency' => array( 'element' => 'item_style', 'value' => array( 'standard-shader', 'standard-switch-images' ) ),
							'group'      => esc_html__( 'Content Layout', 'biagiotti-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Enable Title', 'biagiotti-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Title Text Transform', 'biagiotti-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Enable Category', 'biagiotti-core' ),
							'value'      => array_flip( biagiotti_mikado_get_yes_no_select_array( false, true ) ),
							'group'      => esc_html__( 'Content Layout', 'biagiotti-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Enable Number of Images', 'biagiotti-core' ),
							'value'      => array_flip( biagiotti_mikado_get_yes_no_select_array( false, true ) ),
							'dependency' => array( 'element' => 'type', 'value' => array( 'gallery' ) ),
							'group'      => esc_html__( 'Content Layout', 'biagiotti-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Enable Excerpt', 'biagiotti-core' ),
							'value'      => array_flip( biagiotti_mikado_get_yes_no_select_array( false ) ),
							'group'      => esc_html__( 'Content Layout', 'biagiotti-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Excerpt Length', 'biagiotti-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Pagination Type', 'biagiotti-core' ),
							'value'      => array(
								esc_html__( 'None', 'biagiotti-core' )            => 'no-pagination',
								esc_html__( 'Standard', 'biagiotti-core' )        => 'standard',
								esc_html__( 'Load More', 'biagiotti-core' )       => 'load-more',
								esc_html__( 'Infinite Scroll', 'biagiotti-core' ) => 'infinite-scroll'
							),
						...
						array(
							...
							'heading'    => esc_html__( 'Load More Top Margin (px or %)', 'biagiotti-core' ),
						...
						array(
							'type'       => 'dropdown',
							'param_name' => 'filter',
							'heading'    => esc_html__( 'Enable Category Filter', 'biagiotti-core' ),
							'value'      => array_flip( biagiotti_mikado_get_yes_no_select_array( false ) ),
							'group'      => esc_html__( 'Additional Features', 'biagiotti-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Filter Order By', 'biagiotti-core' ),
							'value'      => array(
								esc_html__( 'Name', 'biagiotti-core' )  => 'name',
								esc_html__( 'Count', 'biagiotti-core' ) => 'count',
								esc_html__( 'Id', 'biagiotti-core' )    => 'id',
								esc_html__( 'Slug', 'biagiotti-core' )  => 'slug'
							),
						...
						array(
							...
							'heading'    => esc_html__( 'Filter Text Transform', 'biagiotti-core' ),
							'value'      => array_flip( biagiotti_mikado_get_text_transform_array( true ) ),
							'dependency' => array( 'element' => 'filter', 'value' => array( 'yes' ) ),
							'group'      => esc_html__( 'Additional Features', 'biagiotti-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Filter Bottom Margin (px or %)', 'biagiotti-core' ),
							'dependency' => array( 'element' => 'filter', 'value' => array( 'yes' ) ),
							'group'      => esc_html__( 'Additional Features', 'biagiotti-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Enable Article Animation', 'biagiotti-core' ),
							'value'       => array_flip( biagiotti_mikado_get_yes_no_select_array( false ) ),
							'description' => esc_html__( 'Enabling this option you will enable appears animation for your portfolio list items', 'biagiotti-core' ),
							'group'       => esc_html__( 'Additional Features', 'biagiotti-core' )
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$additional_params['holder_data']          = biagiotti_mikado_get_holder_data_for_cpt( $params, $additional_params );
		...
		$html = biagiotti_core_get_cpt_shortcode_module_template_part( 'portfolio', 'portfolio-list', 'portfolio-holder', $params['type'], $params, $additional_params );
	...
	public function getHolderClasses( $params, $args ) {
		...
		$classes[] = ! empty( $params['navigation_position'] ) ? 'mkdf-nav-' . $params['navigation_position'] : '';
		...
		if ( $params['type'] == 'masonry' && $params['enable_fixed_proportions'] === 'yes' ) {
			...
			switch ( $fixed_image_size ) {
				...
				case 'large-width-height':
					$thumb_size = 'biagiotti_mikado_image_huge';
					break;
				default :
					$thumb_size = 'full';
					break;
	...
	public function getStandardContentStyles( $params ) {
		...
		if ( ! empty( $margin_top ) ) {
			if ( biagiotti_mikado_string_ends_with( $margin_top, '%' ) || biagiotti_mikado_string_ends_with( $margin_top, 'px' ) ) {
				$styles[] = 'margin-top: ' . $margin_top;
			} else {
				$styles[] = 'margin-top: ' . biagiotti_mikado_filter_px( $margin_top ) . 'px';
			}
		}
		
		if ( ! empty( $margin_bottom ) ) {
			if ( biagiotti_mikado_string_ends_with( $margin_bottom, '%' ) || biagiotti_mikado_string_ends_with( $margin_bottom, 'px' ) ) {
				$styles[] = 'margin-bottom: ' . $margin_bottom;
			} else {
				$styles[] = 'margin-bottom: ' . biagiotti_mikado_filter_px( $margin_bottom ) . 'px';
			}
		}
	...
	public function getLoadMoreStyles( $params ) {
		...
		if ( ! empty( $params['load_more_top_margin'] ) ) {
			...
			if ( biagiotti_mikado_string_ends_with( $margin, '%' ) || biagiotti_mikado_string_ends_with( $margin, 'px' ) ) {
				$styles[] = 'margin-top: ' . $margin;
			} else {
				$styles[] = 'margin-top: ' . biagiotti_mikado_filter_px( $margin ) . 'px';
			}
		}
	...
	public function getFilterHolderStyles( $params ) {
		...
		if ( ! empty( $params['filter_bottom_margin'] ) ) {
			...
			if ( biagiotti_mikado_string_ends_with( $margin, '%' ) || biagiotti_mikado_string_ends_with( $margin, 'px' ) ) {
				...
				$styles[] = 'margin-bottom: ' . biagiotti_mikado_filter_px( $margin ) . 'px';
			}
		}
	...
	public function getItemLink() {
		...
		return apply_filters( 'biagiotti_mikado_filter_portfolio_external_link', $portfolio_link );
	}
	...
	public function getItemLinkTarget() {
		...
		return apply_filters( 'biagiotti_mikado_filter_portfolio_external_link_target', $portfolio_link_target );
	}
