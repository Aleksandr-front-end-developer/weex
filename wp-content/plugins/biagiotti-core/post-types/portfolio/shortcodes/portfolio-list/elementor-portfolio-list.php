...
class BiagiottiCoreElementorPortfolioList extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Portfolio List', 'biagiotti-core' );
    }

    public function get_icon() {
        return 'biagiotti-elementor-custom-icon biagiotti-elementor-portfolio-list';
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'type',
            [
                'label'   => esc_html__( 'Portfolio List Template', 'biagiotti-core' ),
                'type'    => \Elementor\Controls_Manager::SELECT,
                'options' => [
                    'gallery' => esc_html__( 'Gallery', 'biagiotti-core' ),
                    'masonry' => esc_html__( 'Masonry', 'biagiotti-core' ),
                ],
                'default' => 'gallery'
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'       => esc_html__( 'Enable Fixed Image Proportions', 'biagiotti-core' ),
                'type'        => \Elementor\Controls_Manager::SELECT,
        ...
        $this->start_controls_section(
            'additional_features',
            [
                'label' => esc_html__( 'Additional Features', 'biagiotti-core' ),
                'tab'   => \Elementor\Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $this->add_control(
            'pagination_type',
            [
                'label'   => esc_html__( 'Pagination Type', 'biagiotti-core' ),
                'type'    => \Elementor\Controls_Manager::SELECT,
                'options' => [
                    'no-pagination'   => esc_html__( 'None', 'biagiotti-core' ),
                    'standard'        => esc_html__( 'Standard', 'biagiotti-core' ),
                    'load-more'       => esc_html__( 'Load More', 'biagiotti-core' ),
                    'infinite-scroll' => esc_html__( 'Infinite Scroll', 'biagiotti-core' ),
                ],
        ...
        $this->add_control(
            ...
            [
                'label'       => esc_html__( 'Load More Top Margin (px or %)', 'biagiotti-core' ),
                'type'        => \Elementor\Controls_Manager::TEXT,
                'description' => esc_html__( 'Number of characters', 'biagiotti-core' ),
                'condition'   => [
        ...
        $this->add_control(
            'filter',
            [
                'label'   => esc_html__( 'Enable Category Filter', 'biagiotti-core' ),
                'type'    => \Elementor\Controls_Manager::SELECT,
                'options' => biagiotti_mikado_get_yes_no_select_array( false ),
                'default' => 'no'
            ]
        ...
        $this->add_control(
            'filter_order_by',
            [
                'label'     => esc_html__( 'Filter Order By', 'biagiotti-core' ),
                'type'      => \Elementor\Controls_Manager::SELECT,
                'options'   => [
                    'name'  => esc_html__( 'Name', 'biagiotti-core' ),
                    'count' => esc_html__( 'Count', 'biagiotti-core' ),
                    'id'    => esc_html__( 'Id', 'biagiotti-core' ),
                    'slug'  => esc_html__( 'Slug', 'biagiotti-core' ),
                ],
                'condition' => [
                    'filter' => array( 'yes' )
                ],
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__( 'Filter Text Transform', 'biagiotti-core' ),
                'type'      => \Elementor\Controls_Manager::SELECT,
                'options'   => biagiotti_mikado_get_text_transform_array( true ),
                'condition' => [
                    'filter' => array( 'yes' )
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__( 'Filter Bottom Margin (px or %)', 'biagiotti-core' ),
                'type'      => \Elementor\Controls_Manager::TEXT,
                'condition' => [
                    'filter' => array( 'yes' )
                ],
        ...
        $this->add_control(
            ...
            [
                'label'       => esc_html__( 'Enable Article Animation', 'biagiotti-core' ),
                'type'        => \Elementor\Controls_Manager::SELECT,
                'options'     => biagiotti_mikado_get_yes_no_select_array( false ),
    ...
    public function render() {
        ...
        echo biagiotti_core_get_cpt_shortcode_module_template_part( 'portfolio', 'portfolio-list', 'portfolio-holder', $params['type'], $params, $additional_params );
    }
	...
	public function getHolderInnerClasses( $params ) {
		...
		$classes[] = isset($params['portfolio_slider_on']) && $params['portfolio_slider_on'] === 'yes' ? 'mkdf-owl-slider mkdf-list-is-slider' : '';
...
\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new BiagiottiCoreElementorPortfolioList() );