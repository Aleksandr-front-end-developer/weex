<?php
namespace BiagiottiCore\CPT\Shortcodes\CallToAction;
...
class CallToAction implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Call To Action', 'biagiotti-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Set Content In Grid', 'biagiotti-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Content Elements Proportion', 'biagiotti-core' ),
							'value'      => array(
								esc_html__( '80/20', 'biagiotti-core' ) => '80',
								esc_html__( '75/25', 'biagiotti-core' ) => '75',
								esc_html__( '66/33', 'biagiotti-core' ) => '66',
								esc_html__( '50/50', 'biagiotti-core' ) => '50'
							),
							'dependency' => array( 'element' => 'layout', 'value' => array( 'normal' ) )
						),
						array(
						...
						array(
							...
							'group'      => esc_html__( 'Button Style', 'biagiotti-core' )
						),
						array(
							'type'        => 'dropdown',
						...
						array(
							...
							'heading'     => esc_html__( 'Button Size', 'biagiotti-core' ),
							'value'       => array(
						...
						array(
							...
							'value'      => esc_html__( 'I am test text for Call to Action shortcode content', 'biagiotti-core' )
						)
					)
				)
			);
	...
	public function render( $atts, $content = null ) {
		...
		$html = biagiotti_core_get_shortcode_module_template_part( 'templates/call-to-action', 'call-to-action', '', $params );
