...
class BiagiottiCoreElementorIcon extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Icon', 'biagiotti-core' );
    }

    public function get_icon() {
        return 'biagiotti-elementor-custom-icon biagiotti-elementor-icon';
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'size',
            [
                'label'   => esc_html__( 'Size', 'biagiotti-core' ),
                ...
                'options' => [
                    ...
                    'mkdf-icon-huge'   => esc_html__( 'Huge', 'biagiotti-core' ),
                ]
            ]
        );
        ...
        $this->add_control(
            'custom_size',
            [
                'label' => esc_html__( 'Custom Size (px)', 'biagiotti-core' ),
                'type'  => \Elementor\Controls_Manager::TEXT,
            ]
        );
        ...
        $this->add_control(
            'border_radius',
            [
                'label'       => esc_html__( 'Border Radius', 'biagiotti-core' ),
                'type'        => \Elementor\Controls_Manager::TEXT,
                'description' => esc_html__( 'Please insert border radius(Rounded corners) in px. For example: 4 ', 'biagiotti-core' ),
                'condition'   => [
        ...
        $this->add_control(
            'border_color',
            [
                'label'     => esc_html__( 'Border Color', 'biagiotti-core' ),
                'type'      => \Elementor\Controls_Manager::COLOR,
                'condition' => [
                    'type' => array( 'mkdf-circle', 'mkdf-square' )
                ],
        ...
        $this->add_control(
            'border_width',
            [
                'label'     => esc_html__( 'Border Width', 'biagiotti-core' ),
                'type'      => \Elementor\Controls_Manager::TEXT,
                'condition' => [
                    'type' => array( 'mkdf-circle', 'mkdf-square' )
                ],
        ...
        $this->add_control(
            'hover_icon_color',
            [
                'label' => esc_html__( 'Hover Icon Color', 'biagiotti-core' ),
                'type'  => \Elementor\Controls_Manager::COLOR,
            ]
        );
        ...
        $this->add_control(
            'hover_border_color',
            [
                'label'     => esc_html__( 'Hover Border Color', 'biagiotti-core' ),
                'type'      => \Elementor\Controls_Manager::COLOR,
                'condition' => [
                    'type' => array( 'mkdf-circle', 'mkdf-square' )
                ],
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__( 'Hover Background Color', 'biagiotti-core' ),
                'type'      => \Elementor\Controls_Manager::COLOR,
                'condition' => [
                    'type' => array( 'mkdf-circle', 'mkdf-square' )
                ],
        ...
        $this->add_control(
            'margin',
            [
                'label'       => esc_html__( 'Margin', 'biagiotti-core' ),
                'type'        => \Elementor\Controls_Manager::TEXT,
        ...
        $this->add_control(
            'anchor_icon',
            [
                'label'       => esc_html__( 'Use Link as Anchor', 'biagiotti-core' ),
                'type'        => \Elementor\Controls_Manager::SELECT,
                'options'     => biagiotti_mikado_get_yes_no_select_array(),
                'description' => esc_html__( 'Check this box to use icon as anchor link (eg. #contact)', 'biagiotti-core' ),
                'condition'   => [
                    'link!' => ''
                ],
            ]
    ...
    public function render() {
        ...
        echo biagiotti_core_get_shortcode_module_template_part( 'templates/icon', 'icon', '', $params );
    }
	...
	private function generateIconStyles( $params ) {
		...
		if ( ( $params['type'] !== 'mkdf-normal' && ! empty( $params['shape_size'] ) ) || ( $params['type'] == 'mkdf-normal' ) ) {
			if ( ! empty( $params['custom_size'] ) ) {
				$iconStyles[] = 'font-size:' . biagiotti_mikado_filter_px( $params['custom_size'] ) . 'px';
			}
		}
	...
	private function generateIconHolderStyles( $params ) {
		...
		if ( $params['type'] !== 'mkdf-normal' ) {
			...
			if ( ! empty( $shapeSize ) ) {
				$iconHolderStyles[] = 'width: ' . biagiotti_mikado_filter_px( $shapeSize ) . 'px';
				$iconHolderStyles[] = 'height: ' . biagiotti_mikado_filter_px( $shapeSize ) . 'px';
				$iconHolderStyles[] = 'line-height: ' . biagiotti_mikado_filter_px( $shapeSize ) . 'px';
			}
			...
			if ( ! empty( $params['border_color'] ) && ( isset( $params['border_width'] ) && $params['border_width'] !== '' ) ) {
				...
				$iconHolderStyles[] = 'border-width: ' . biagiotti_mikado_filter_px( $params['border_width'] ) . 'px';
			...
			if ( $params['type'] == 'mkdf-square' ) {
				if ( isset( $params['border_radius'] ) && $params['border_radius'] !== '' ) {
					$iconHolderStyles[] = 'border-radius: ' . biagiotti_mikado_filter_px( $params['border_radius'] ) . 'px';
				}
			}
		}
...
\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new BiagiottiCoreElementorIcon() );