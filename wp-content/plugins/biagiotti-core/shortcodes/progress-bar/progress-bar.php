<?php
namespace BiagiottiCore\CPT\Shortcodes\ProgressBar;
...
class ProgressBar implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Progress Bar', 'biagiotti-core' ),
					'base'                      => $this->base,
					...
					'params'                    => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Percentage Type', 'biagiotti-core' ),
							'value'      => array(
								esc_html__( 'Default', 'biagiotti-core' )  => '',
								esc_html__( 'Floating', 'biagiotti-core' ) => 'floating'
							),
						...
						array(
							...
							'heading'    => esc_html__( 'Active Color', 'biagiotti-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'color_inactive',
							'heading'    => esc_html__( 'Inactive Color', 'biagiotti-core' )
						)
					)
				)
			);
	...
	public function render( $atts, $content = null ) {
		...
		$html = biagiotti_core_get_shortcode_module_template_part( 'templates/progress-bar-template', 'progress-bar', '', $params );
