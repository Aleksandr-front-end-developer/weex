<?php
namespace BiagiottiCore\CPT\Shortcodes\IconListItem;
...
class IconListItem implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'     => esc_html__( 'Icon List Item', 'biagiotti-core' ),
					'base'     => $this->base,
					...
					'params'   => array_merge(
						array(
							...
							array(
								...
								'heading'     => esc_html__( 'Icon List Item Bottom Margin (px)', 'biagiotti-core' ),
						...
						array(
							array(
								...
								'heading'    => esc_html__( 'Icon Size (px)', 'biagiotti-core' )
							),
							array(
								'type'       => 'colorpicker',
							...
							array(
								...
								'heading'    => esc_html__( 'Title Size (px)', 'biagiotti-core' ),
							...
							array(
								...
								'heading'     => esc_html__( 'Title Left Padding (px)', 'biagiotti-core' ),
	...
	public function render( $atts, $content = null ) {
		...
		$args   = array_merge( $args, biagiotti_mikado_icon_collections()->getShortcodeParams() );
		...
		$html = biagiotti_core_get_shortcode_module_template_part( 'templates/icon-list-item-template', 'icon-list-item', '', $params );
