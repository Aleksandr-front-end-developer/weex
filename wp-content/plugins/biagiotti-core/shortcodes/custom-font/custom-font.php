...
namespace BiagiottiCore\CPT\Shortcodes\CustomFont;
...
class CustomFont implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Custom Font', 'biagiotti-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							'type'       => 'textfield',
							'param_name' => 'title',
							'heading'    => esc_html__( 'Title Text', 'biagiotti-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'type_out_effect',
							'heading'     => esc_html__( 'Enable Type Out Effect', 'biagiotti-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Position of Type Out Effect', 'biagiotti-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Typed Color', 'biagiotti-core' ),
							'dependency' => array( 'element' => 'type_out_effect', 'value' => array( 'yes' ) )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'typed_ending_1',
							'heading'    => esc_html__( 'Typed Ending Number 1', 'biagiotti-core' ),
							'dependency' => Array( 'element' => 'type_out_effect', 'value' => array( 'yes' ) )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'typed_ending_2',
							'heading'    => esc_html__( 'Typed Ending Number 2', 'biagiotti-core' ),
							'dependency' => array( 'element' => 'typed_ending_1', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'typed_ending_3',
							'heading'    => esc_html__( 'Typed Ending Number 3', 'biagiotti-core' ),
							'dependency' => array( 'element' => 'typed_ending_2', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'typed_ending_4',
							'heading'    => esc_html__( 'Typed Ending Number 4', 'biagiotti-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Font Family', 'biagiotti-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'font_size',
							'heading'    => esc_html__( 'Font Size (px or em)', 'biagiotti-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'line_height',
							'heading'    => esc_html__( 'Line Height (px or em)', 'biagiotti-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'font_weight',
							'heading'     => esc_html__( 'Font Weight', 'biagiotti-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Font Style', 'biagiotti-core' ),
							'value'       => array_flip( biagiotti_mikado_get_font_style_array( true ) ),
							'save_always' => true
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'letter_spacing',
							'heading'    => esc_html__( 'Letter Spacing (px or em)', 'biagiotti-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'text_transform',
							'heading'     => esc_html__( 'Text Transform', 'biagiotti-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Text Decoration', 'biagiotti-core' ),
							'value'       => array_flip( biagiotti_mikado_get_text_decorations( true ) ),
							'save_always' => true
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'color',
							'heading'    => esc_html__( 'Color', 'biagiotti-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'text_align',
							'heading'     => esc_html__( 'Text Align', 'biagiotti-core' ),
							'value'       => array(
								...
								esc_html__( 'Justify', 'biagiotti-core' ) => 'justify'
							),
							'save_always' => true
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'margin',
							'heading'     => esc_html__( 'Margin (px or %)', 'biagiotti-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Font Size (px or em)', 'biagiotti-core' ),
							'group'      => esc_html__( 'Laptops', 'biagiotti-core' )
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'heading'    => esc_html__( 'Font Size (px or em)', 'biagiotti-core' ),
							'group'      => esc_html__( 'Tablets Landscape', 'biagiotti-core' )
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'heading'    => esc_html__( 'Font Size (px or em)', 'biagiotti-core' ),
							'group'      => esc_html__( 'Tablets Portrait', 'biagiotti-core' )
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'heading'    => esc_html__( 'Font Size (px or em)', 'biagiotti-core' ),
							'group'      => esc_html__( 'Mobiles', 'biagiotti-core' )
						),
						array(
							'type'       => 'textfield',
	...
	public function render( $atts, $content = null ) {
		...
		if ( $params['type_out_effect'] === 'yes' ) {
			wp_enqueue_script( 'typed', BIAGIOTTI_CORE_SHORTCODES_URL_PATH . '/custom-font/assets/js/plugins/typed.js', array( 'jquery' ), false, true );
		}
		
		$html = biagiotti_core_get_shortcode_module_template_part( 'templates/custom-font', 'custom-font', '', $params );
