<?php
namespace BiagiottiCore\CPT\Shortcodes\ImageGallery;
...
class ImageGallery implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Image Gallery', 'biagiotti-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							'type'        => 'dropdown',
							'param_name'  => 'type',
							'heading'     => esc_html__( 'Gallery Type', 'biagiotti-core' ),
							'value'       => array(
								esc_html__( 'Image Grid', 'biagiotti-core' ) => 'grid',
								esc_html__( 'Masonry', 'biagiotti-core' )    => 'masonry',
								esc_html__( 'Slider', 'biagiotti-core' )     => 'slider',
								esc_html__( 'Carousel', 'biagiotti-core' )   => 'carousel'
							),
							'save_always' => true,
							'admin_label' => true
						),
						array(
							'type'        => 'attach_images',
							'param_name'  => 'images',
							'heading'     => esc_html__( 'Images', 'biagiotti-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Custom Links', 'biagiotti-core' ),
						...
						array(
							...
							'group'       => esc_html__( 'Slider Settings', 'biagiotti-core' )
						),
						array(
							'type'        => 'dropdown',
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Padding', 'biagiotti-core' ),
	...
	public function render( $atts, $content = null ) {
		...
		$html = biagiotti_core_get_shortcode_module_template_part( 'templates/' . $params['type'], 'image-gallery', '', $params );
