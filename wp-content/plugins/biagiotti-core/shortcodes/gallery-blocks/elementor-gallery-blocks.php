...
class BiagiottiCoreElementorGalleryBlocks extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Gallery Blocks', 'biagiotti-core' );
	}

	public function get_icon() {
		return 'biagiotti-elementor-custom-icon biagiotti-elementor-gallery-blocks';
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'images',
			[
				'label'       => esc_html__( 'Images', 'manon-core' ),
				'type'        => \Elementor\Controls_Manager::GALLERY,
				'description' => esc_html__( 'Select images from media library. The first image you upload will be set as the featured image if you set Featured Image Size.', 'manon-core' )
			]
		);
		...
		$this->add_control(
			'featured_image_size',
			[
				'label'       => esc_html__( 'Featured Image Size', 'biagiotti-core' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
		...
		$this->add_control(
			'enable_lightbox',
			[
				'label'     => esc_html__( 'Enable Lightbox Functionality', 'biagiotti-core' ),
		...
		$this->add_control(
			...
			[
				...
				'type'      => \Elementor\Controls_Manager::SELECT,
				'options'   => biagiotti_mikado_get_space_between_items_array(false),
				'default'	=> 'normal'
			]
		);
	...
	public function render() {
		...
		$params['enable_lightbox']     = ( $params['enable_lightbox'] === 'yes' );

		echo biagiotti_core_get_shortcode_module_template_part( 'templates/gallery-blocks', 'gallery-blocks', '', $params );
	}
...
\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new BiagiottiCoreElementorGalleryBlocks() );