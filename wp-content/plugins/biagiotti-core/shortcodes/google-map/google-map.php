<?php
namespace BiagiottiCore\CPT\Shortcodes\GoogleMap;
...
class GoogleMap implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                    => esc_html__( 'Google Map', 'biagiotti-core' ),
					'base'                    => $this->base,
					...
					'params'                  => array(
						array(
							'type'       => 'textfield',
							'param_name' => 'address1',
							'heading'    => esc_html__( 'Address 1', 'biagiotti-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'address2',
							'heading'    => esc_html__( 'Address 2', 'biagiotti-core' ),
							'dependency' => Array( 'element' => 'address1', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'address3',
							'heading'    => esc_html__( 'Address 3', 'biagiotti-core' ),
							'dependency' => Array( 'element' => 'address2', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'address4',
							'heading'    => esc_html__( 'Address 4', 'biagiotti-core' ),
							'dependency' => Array( 'element' => 'address3', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'address5',
							'heading'    => esc_html__( 'Address 5', 'biagiotti-core' ),
							'dependency' => Array( 'element' => 'address4', 'not_empty' => true )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'snazzy_map_style',
							'heading'     => esc_html__( 'Snazzy Map Style', 'biagiotti-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Snazzy Map Code', 'biagiotti-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Custom Map Style', 'biagiotti-core' ),
							'value'       => array_flip( biagiotti_mikado_get_yes_no_select_array( false ) ),
						...
						array(
							...
							'heading'     => esc_html__( 'Color Overlay', 'biagiotti-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Saturation', 'biagiotti-core' ),
							'description' => esc_html__( 'Choose a level of saturation (-100 = least saturated, 100 = most saturated)', 'biagiotti-core' ),
							'dependency'  => Array( 'element' => 'custom_map_style', 'value' => array( 'yes' ) )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'lightness',
							'heading'     => esc_html__( 'Lightness', 'biagiotti-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Zoom Map on Mouse Wheel', 'biagiotti-core' ),
							'value'       => array_flip( biagiotti_mikado_get_yes_no_select_array( false ) ),
						...
						array(
							...
							'heading'    => esc_html__( 'Map Height', 'biagiotti-core' )
						)
					)
				)
			);
	...
	public function render( $atts, $content = null ) {
		...
		$html = biagiotti_core_get_shortcode_module_template_part( 'templates/google-map-template', 'google-map', '', $params );
