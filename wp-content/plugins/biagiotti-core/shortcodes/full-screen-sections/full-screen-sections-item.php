<?php
namespace BiagiottiCore\CPT\Shortcodes\FullScreenSections;
...
class FullScreenSectionsItem implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'            => esc_html__( 'Full Screen Sections Item', 'biagiotti-core' ),
					'base'            => $this->base,
					...
					'params'          => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Background Image Position', 'biagiotti-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Background Image Size', 'biagiotti-core' ),
							'value'       => array(
								esc_html__( 'Cover', 'biagiotti-core' )   => 'cover',
								esc_html__( 'Contain', 'biagiotti-core' ) => 'contain',
								esc_html__( 'Inherit', 'biagiotti-core' ) => 'inherit'
							),
							'save_always' => true,
							'dependency'  => array('item' => 'background_image', 'not_empty' => true)
						),
						...
						array(
							...
							'heading'     => esc_html__( 'Content Horizontal Alignment', 'biagiotti-core' ),
							'value'       => array(
								esc_html__( 'Default', 'biagiotti-core' ) => '',
						...
						array(
							...
							'heading'     => esc_html__( 'Header and Navigation Skin', 'biagiotti-core' ),
							'value'       => array(
								esc_html__( 'Default', 'biagiotti-core' ) => '',
								esc_html__( 'Light', 'biagiotti-core' )   => 'light',
								esc_html__( 'Dark', 'biagiotti-core' )    => 'dark'
							),
							'save_always' => true,
						...
						array(
							...
							'heading'     => esc_html__('Background Image for Laptops', 'biagiotti-core'),
							'group'       => esc_html__('Responsiveness', 'biagiotti-core')
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_tablet',
							'heading'     => esc_html__('Background Image for Tablets - Landscape', 'biagiotti-core'),
							'group'       => esc_html__('Responsiveness', 'biagiotti-core')
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_tablet_portrait',
							'heading'     => esc_html__('Background Image for Tablets - Portrait', 'biagiotti-core'),
							'group'       => esc_html__('Responsiveness', 'biagiotti-core')
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_mobile',
							'heading'     => esc_html__('Background Image for Mobiles', 'biagiotti-core'),
							'group'       => esc_html__('Responsiveness', 'biagiotti-core')
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$html = biagiotti_core_get_shortcode_module_template_part( 'templates/full-screen-sections-item', 'full-screen-sections', '', $params );
