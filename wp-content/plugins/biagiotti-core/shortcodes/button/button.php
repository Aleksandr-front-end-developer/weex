<?php
namespace BiagiottiCore\CPT\Shortcodes\Button;
...
class Button implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Button', 'biagiotti-core' ),
					'base'                      => $this->base,
					...
					'params'                    => array_merge(
						array(
							...
							array(
								...
								'value'       => esc_html__( 'Button Text', 'biagiotti-core' ),
								'save_always' => true,
								'admin_label' => true
							),
							array(
						...
						biagiotti_mikado_icon_collections()->getVCParamsArray( array(), '', true ),
						array(
							array(
								'type'       => 'colorpicker',
								'param_name' => 'color',
								'heading'    => esc_html__( 'Color', 'biagiotti-core' ),
								'group'      => esc_html__( 'Design Options', 'biagiotti-core' )
							),
							array(
								'type'       => 'colorpicker',
								'param_name' => 'hover_color',
								'heading'    => esc_html__( 'Hover Color', 'biagiotti-core' ),
								'group'      => esc_html__( 'Design Options', 'biagiotti-core' )
							),
							array(
								'type'       => 'colorpicker',
							...
							array(
								...
								'heading'    => esc_html__( 'Font Size (px)', 'biagiotti-core' ),
								'group'      => esc_html__( 'Design Options', 'biagiotti-core' )
							),
							array(
								'type'        => 'dropdown',
							...
							array(
								'type'        => 'textfield',
								'param_name'  => 'padding',
								'heading'     => esc_html__( 'Button Padding', 'biagiotti-core' ),
	...
	public function render( $atts, $content = null ) {
		...
		return biagiotti_core_get_shortcode_module_template_part( 'templates/' . $params['html_type'], 'button', '', $params );
	}
