<?php
namespace BiagiottiCore\CPT\Shortcodes\Accordion;
...
class Accordion implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                    => esc_html__( 'Accordion', 'biagiotti-core' ),
					'base'                    => $this->base,
					...
					'params'                  => array(
						...
						array(
							...
							'value'      => array(
								esc_html__( 'Accordion', 'biagiotti-core' ) => 'accordion',
								esc_html__( 'Toggle', 'biagiotti-core' )    => 'toggle'
							)
						),
						array(
							'type'       => 'dropdown',
							...
							'value'      => array(
								esc_html__( 'Boxed', 'biagiotti-core' )  => 'boxed',
						...
						array(
							...
							'heading'    => esc_html__( 'Background Skin', 'biagiotti-core' ),
							'value'      => array(
								esc_html__( 'Default', 'biagiotti-core' ) => '',
								esc_html__( 'White', 'biagiotti-core' )   => 'white'
							),
	...
	public function render( $atts, $content = null ) {
		...
		$output = biagiotti_core_get_shortcode_module_template_part( 'templates/accordion-holder-template', 'accordions', '', $params );
