...
namespace BiagiottiCore\CPT\Shortcodes\AccordionTab;
...
class AccordionTab implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					"name"                    => esc_html__( 'Accordion Tab', 'biagiotti-core' ),
					"base"                    => $this->base,
	...
	public function render( $atts, $content = null ) {
		...
		$output = biagiotti_core_get_shortcode_module_template_part( 'templates/accordion-template', 'accordions', '', $params );
